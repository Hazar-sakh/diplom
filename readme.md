...
## Содержание
1. [Обзор проекта](##Обзор_проекта)
2. [Структура проекта](#Структура_проекта)
3. [Обзор библиотек и реализация визуализации:](#Обзор_библиотек_и_реализация_визуализации:)
   - [Matplotlib](#Matplotlib)
   - [Seaborn](#Seaborn)
   - [Plotly](#Plotly)
4. [Сравнительный анализ библиотек](#Сравнительный_анализ_библиотек)
